...
export default function WorkspaceChatPage({ params }: WorkspaceChatPageProps) {
  ...
  const handleSend = (prompt: string) => {
    ...
    // 重定向到项目的 chat 页面，并通过 query 参数传递 prompt，包含 workspace 前缀
    router.push(`/${workspace}/chat/${activeProjectId}?prompt=${encodeURIComponent(prompt)}`);
  };
